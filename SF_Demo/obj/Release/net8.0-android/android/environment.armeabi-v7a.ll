...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 149, ; uint32_t number_of_assemblies_in_apk (0x95)
	i32 0, ; uint32_t bundled_assembly_name_width (0x0)
	i32 2, ; uint32_t number_of_assembly_store_files (0x2)
	i32 702, ; uint32_t number_of_dso_cache_entries (0x2be)
	i32 33555225, ; uint32_t android_runtime_jnienv_class_token (0x2000319)
	i32 100671798, ; uint32_t jnienv_initialize_method_token (0x6002136)
	i32 100671797, ; uint32_t jnienv_registerjninatives_method_token (0x6002135)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [702 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-Syncfusion.Maui.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 2
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.31_name, ; name: libaot-Syncfusion.Maui.ListView.dll.so
		ptr null; void* handle (0x0)
	}, ; 6
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.32_name, ; name: libaot-Syncfusion.Maui.PullToRefresh.dll.so
		ptr null; void* handle (0x0)
	}, ; 12
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.26_name, ; name: libaot-Syncfusion.Maui.Data.dll.so
		ptr null; void* handle (0x0)
	}, ; 14
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.24_name, ; name: libaot-Syncfusion.Licensing.dll.so
		ptr null; void* handle (0x0)
	}, ; 23
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.81_name, ; name: libaot-System.Linq.Parallel.dll.so
		ptr null; void* handle (0x0)
	}, ; 31
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 633198127, ; hash 0x25bdd62f, from name: libaot-SF_Demo
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SF_Demo.dll.so
		ptr null; void* handle (0x0)
	}, ; 94
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.96_name, ; name: libaot-System.Reflection.Emit.dll.so
		ptr null; void* handle (0x0)
	}, ; 107
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 911586944, ; hash 0x3655b680, from name: aot-SF_Demo
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SF_Demo.dll.so
		ptr null; void* handle (0x0)
	}, ; 145
	...
	%struct.DSOCacheEntry {
		i64 1113269217, ; hash 0x425b23e1, from name: libaot-SF_Demo.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SF_Demo.dll.so
		ptr null; void* handle (0x0)
	}, ; 176
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.30_name, ; name: libaot-Syncfusion.Maui.Inputs.dll.so
		ptr null; void* handle (0x0)
	}, ; 178
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1300439036, ; hash 0x4d831ffc, from name: aot-SF_Demo.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SF_Demo.dll.so
		ptr null; void* handle (0x0)
	}, ; 201
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.27_name, ; name: libaot-Syncfusion.Maui.DataGrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 303
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3404746805, ; hash 0xcaf05035, from name: SF_Demo.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SF_Demo.dll.so
		ptr null; void* handle (0x0)
	}, ; 568
	...
	%struct.DSOCacheEntry {
		i64 4053692430, ; hash 0xf19e700e, from name: SF_Demo
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SF_Demo.dll.so
		ptr null; void* handle (0x0)
	}, ; 662
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [149 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
...
@.env.3 = private unnamed_addr constant [37 x i8] c"6a59e843-08ea-403c-8f46-f054fe104906\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [23 x i8] c"com.companyname.sfdemo\00", align 1
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [22 x i8] c"libaot-SF_Demo.dll.so\00", align 1
...
@.DSOCacheEntry.24_name = private unnamed_addr constant [35 x i8] c"libaot-Syncfusion.Licensing.dll.so\00", align 1
@.DSOCacheEntry.25_name = private unnamed_addr constant [35 x i8] c"libaot-Syncfusion.Maui.Core.dll.so\00", align 1
@.DSOCacheEntry.26_name = private unnamed_addr constant [35 x i8] c"libaot-Syncfusion.Maui.Data.dll.so\00", align 1
@.DSOCacheEntry.27_name = private unnamed_addr constant [39 x i8] c"libaot-Syncfusion.Maui.DataGrid.dll.so\00", align 1
...
@.DSOCacheEntry.30_name = private unnamed_addr constant [37 x i8] c"libaot-Syncfusion.Maui.Inputs.dll.so\00", align 1
@.DSOCacheEntry.31_name = private unnamed_addr constant [39 x i8] c"libaot-Syncfusion.Maui.ListView.dll.so\00", align 1
@.DSOCacheEntry.32_name = private unnamed_addr constant [44 x i8] c"libaot-Syncfusion.Maui.PullToRefresh.dll.so\00", align 1
...
@.DSOCacheEntry.81_name = private unnamed_addr constant [35 x i8] c"libaot-System.Linq.Parallel.dll.so\00", align 1
...
@.DSOCacheEntry.96_name = private unnamed_addr constant [37 x i8] c"libaot-System.Reflection.Emit.dll.so\00", align 1
